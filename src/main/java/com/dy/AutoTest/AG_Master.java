...
public class AG_Master {
	...
	public static final String caseName="SuspiciousTradeManagement_BeingProcessedSuspiciousTradeMaintain";
	public static final String caseNameAlias="BeingProcessedSuspiciousTradeMaintain";
